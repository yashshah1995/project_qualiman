...
#' This following function is the mainbody. The directory structure for reference is
#' as follows
#' -Body
#'     - TabItems
#'         - tabitem (tabsetPanel, tabBox(useful for adding common boxes across pane))
...
body <- dashboardBody(
  ...
  tabItem(tabName = "K2_criteria",
          fluidRow(tabsetPanel(
            ...
            tabPanel("combinedplot", value = "k2dkede", plotOutput("plotk2dkede"),
  ...
  textOutput(outputId="user_role"),
  tags$footer(p("Version: 0.1.210331",style="font-size: 11px; text-align: end;"
                ),
              style = "
                position:absolute;
                bottom:0;
